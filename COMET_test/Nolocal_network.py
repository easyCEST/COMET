...
class NLBlockND(nn.Module):
    ...
    def forward(self, x):
        ...
        return z
class NLBlock_new(nn.Module):
    def __init__(self, in_channels, num_block=8,inter_channels=None, mode='embedded',
        ...
        args:
            ...
            bn_layer: whether to add batch norm
        """
        super(NLBlock_new, self).__init__()
        ...
        self.in_channels = in_channels * num_block**2
        self.inter_channels = inter_channels
    ...
    def forward(self, x):
        ...
        # residual connection
        z = W_y + x
        z = depth_to_space(z, self.num_block)

        return z

def space_to_depth(x, block_size):  # only for 4D
...
def depth_to_space(x ,block_size):
    return torch.pixel_shuffle(x, block_size)
